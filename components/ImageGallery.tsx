...
export default function ImageGallery({ images, isLoading, viewMode, onImageClick }: ImageGalleryProps) {
  if (isLoading) {
  ...
  return (
    <div className={`${gridClass} animate-fade-in`}>
      {images.map((image, index) => (
        <div key={image.id} style={{ animationDelay: `${index * 0.1}s` }} className="animate-slide-up">
