function UploadModal({ onClose, onUpload, user }) {
  try {
    ...
    return (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" data-name="upload-modal" data-file="components/UploadModal.js">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <div className="flex space-x-2">
                ...
                <button
                  type="button"
                  onClick={generateSampleImageUrl}
